...
import kotlinx.android.synthetic.main.activity_apple_actvity.*
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response
import java.lang.Exception

class AppleActvity : AppCompatActivity() {

    var mediaPlayer: MediaPlayer? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_apple_actvity)
                ...
                override fun onResponse(
                    ...
                    if (response.isSuccessful){
                        ...
                        val adapter = MelonAdapter(
                            songList!!,
                            LayoutInflater.from(this@AppleActvity),
                            Glide.with(this@AppleActvity),
                            this@AppleActvity
                        )
